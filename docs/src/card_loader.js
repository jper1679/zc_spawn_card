...
function load_card_type(){
	...
	$("#input_card_type_pimp").prop("checked",current_card.card_type == "bersek");
	$("#input_card_type_starting").prop("checked",current_card.card_type == "toxic");
        $("#input_card_type_starting").prop("checked",current_card.card_type == "wolfz");
